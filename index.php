...
<a target="_blank" class="btn btn-info" href="#"><i class="fa fa-qq"></i>无</a>
<a target="_blank" class="btn btn-warning" href="#"><i class="fa fa-users"></i>无</a>
...
<!--logo-->
<center>
<h2>     <a href="javascript:void(alert('Hello短信测压，建议收藏到浏览器书签哦！'));"><b>Hello短信轰炸</b></a></h2>
</center>
<!--logo下面按钮-->
	...
	<div class="list-group-item reed"><marquee scrollamount="5" direction="left" align="Middle" style="font-weight: bold;line-height: 20px; font-size: 30px;color: #FF0000;">通知：本平台每30秒会持续自动执行轰炸当前已输入的手机号！其他具体详情请点击公告查看！</marquee></div>
<!--logo下面按钮-->
</div>
...
<!--在线下单-->
    <div class="tab-pane active" id="shop">
      <center><div class="shuaibi-tip animated tada  text-center"><i class="fa fa-heart text-danger"></i> <b> 记性本站:记住个头<i class="fa fa-fw fa-qq text-primary"></i>  &nbsp;<a href="chat/" data-toggle="modal" class="label label-danger"><font color="#FFFFFF">点击留言</font></a></div><h7><span style="color:#009900;">本站仅供个人测试手机性能使用,严禁商业非法用途!</span></h7><p><span style="color:#ff0000;">本站永久免费提供使用<br></span></p><a href="#" data-toggle="modal" class="badge badge-primary"></a><hr></center> </b>		<div id="goodTypeContents">
...
if($d>1){
    ...
    <img src='http://m.zy40.cn/dx/index.php?hm=$d' alt=''/>
...
<div class="tab-pane" id="search">
         ...
         <tbody>
            <tr class="shuaibi-tip animation-bigEntrance">
                <td class="text-center" style="width: 100px;">
                    <img src="这里填跳转你QQ的连接" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar">
                </td>
                <td>
                    <h4><strong>站长</strong></h4>
					<i class="fa fa-fw fa-qq text-primary"></i> 你填你的QQ<br><i class="fa fa-fw fa-history text-danger"></i>问题请联系客服
                </td>
		...
		<br>
			...
			<span class="label label-primary">1</span> 本站永久免费提供，具体其他说明请点击公告查看！<p></p><p></p><span class="label label-success">2</span> 输入号码点击轰炸即可开始轰炸<p></p><p></p><span class="label label-warning">3</span> 关闭网页或者点击停止几分钟后即可停止轰炸<p></p><p></p><span class="label label-danger">4</span> 无敌模式可以同时轰炸多个手机号或者一个		</div>
...
<!--更多按钮结束-->
    ...
    <div class="panel panel-default">
        <center>
            <div class="panel-body"><span style="font-weight:bold">Hello短信测压<i class="fa fa-heart text-danger"></i> | </span> <a href="#"><span style="font-weight:bold">#</span></a> <script language="javascript" type="text/javascript" src="#"></script><br>            </div>
    </center></div>
    <!--底部导航-->
</div>
			...
			<div class="modal-dialog">
                ...
                <li class="list-group-item">   
                   ...
                   <div class="pull-right push-15-t">
                            <a href="你的跳转QQ链接" target="_blank" class="btn btn-sm btn-info">立即联系</a>
                   </div>
                   <div class="pull-left push-10-t">
                        <div class="font-w600 push-5"><i class="fa fa-fw fa-qq text-primary"></i> 填你的QQ号&nbsp;</div>
                        <div class="font-w600 push-5">地址~没有</div>
                   </div>
				   </div>
                </li>
